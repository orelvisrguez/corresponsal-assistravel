...
export default function CasoForm({ 
  ...
  const {
    ...
    defaultValues: {
      ...
      fee: initialData?.fee,
      costoUsd: initialData?.costoUsd,
      costoMonedaLocal: initialData?.costoMonedaLocal,
      simboloMoneda: initialData?.simboloMoneda || '',
      montoAgregado: initialData?.montoAgregado,
